...
public class GlideBlurTransform implements Transformation<Bitmap> {
    ...
    public GlideBlurTransform(Context context, BitmapPool pool) {
        this(context, pool, MAX_RADIUS, DEFAULT_DOWN_SAMPLING);
    }

    public GlideBlurTransform(Context context, BitmapPool pool, int radius) {
    ...
    public GlideBlurTransform(Context context, BitmapPool pool, int radius, int sampling) {
        mContext = context;
        mBitmapPool = pool;
        mRadius = radius;
        mSampling = sampling;
